  ...
  return (
    <div
      className={cn(
        ...
        prose-h3:text-xl prose-h3:font-semibold prose-h3:mt-10 prose-h3:mb-6
        prose-h6:text-base prose-h6:font-medium prose-h6:mt-0
        prose-p:text-[15px] prose-p:leading-normal prose-p:mt-8 prose-p:text-neutral-700 dark:prose-p:text-neutral-300`,
        className
      )}
      ref={ref}
      {...props}
